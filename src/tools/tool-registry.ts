...
const TOOL_REGISTRY: ToolEntry[] = [
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        accountNumber: { type: "string", description: "The account number" },
        "time-in-force": { type: "string", description: "Time in force (e.g. 'Day', 'GTC', 'GTD', 'Ext', 'GTC Ext', 'IOC')" },
        "order-type": { type: "string", description: "Order type (e.g. 'Limit', 'Market', 'Stop', 'Stop Limit', 'Notional Market')" },
        price: { type: "number", description: "Limit price for the order (required for Limit and Stop Limit orders)" },
        "price-effect": { type: "string", description: "Price effect: 'Debit' (buying) or 'Credit' (selling)" },
        legs: {
          type: "array",
          ...
          items: {
            type: "object",
            properties: {
              "instrument-type": { type: "string", description: "Instrument type (e.g. 'Equity', 'Equity Option', 'Future', 'Future Option')" },
              ...
              "ratio-quantity": { type: "number", description: "Ratio quantity for complex orders" },
            },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        "time-in-force": { type: "string", description: "Time in force (e.g. 'Day', 'GTC', 'GTD', 'Ext', 'GTC Ext', 'IOC')" },
        "order-type": { type: "string", description: "Order type (e.g. 'Limit', 'Market', 'Stop', 'Stop Limit')" },
        price: { type: "number", description: "Limit price for the replacement order" },
        ...
        legs: {
          ...
          items: {
            ...
            properties: {
              ...
              symbol: { type: "string", description: "Symbol for the instrument" },
              action: { type: "string", description: "Order action" },
              quantity: { type: "number", description: "Number of contracts or shares" },
              "ratio-quantity": { type: "number", description: "Ratio quantity" },
            },
            required: ["instrument-type", "symbol", "action", "quantity"],
          },
        },
      },
      required: ["accountNumber", "orderId", "time-in-force", "order-type", "legs"],
    },
    annotations: { readOnlyHint: true, destructiveHint: false, idempotentHint: true, openWorldHint: false },
  },
  {
  ...
  },
  {
    ...
    inputSchema: {
      ...
      required: ["accountNumber", "orderId", "price"],
    },
    annotations: { readOnlyHint: false, destructiveHint: true, idempotentHint: false, openWorldHint: true },
  },
  {
  ...
  // ── Watchlists ────────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        watchlistEntries: {
          type: "array",
          description: "Array of watchlist entries — required for create and replace actions.",
          items: {
            type: "object",
            properties: {
              symbol: { type: "string", description: "The instrument symbol (e.g. 'AAPL', 'SPY')" },
              "instrument-type": { type: "string", description: "Instrument type (e.g. 'Equity', 'Equity Option', 'Future', 'Cryptocurrency')" },
            },
